...
;(function($, window, undefined)
{
	...
	$(document).ready(function()
	{
		...
		if(typeof Morris != 'undefined')
		{
			...
			// Line Chart
			var day_data = [
				{"elapsed": "I", "value1": 34, "value2": 20},
				{"elapsed": "II", "value1": 24, "value2": 30},
				{"elapsed": "III", "value1": 3, "value2": 15},
				{"elapsed": "IV", "value1": 12, "value2": 10},
				{"elapsed": "V", "value1": 13, "value2": 25},
				{"elapsed": "VI", "value1": 22, "value2": 18},
				{"elapsed": "VII", "value1": 5, "value2": 32},
				{"elapsed": "VIII", "value1": 26, "value2": 28},
				{"elapsed": "IX", "value1": 12, "value2": 15},
				{"elapsed": "X", "value1": 19, "value2": 22}
			];
			...
			Morris.Line({
				...
				data: day_data,
				xkey: 'elapsed',
				ykeys: ['value1', 'value2'], // Claves para las dos líneas
				labels: ['Value 1', 'Value 2'], // Etiquetas para las dos líneas
				parseTime: false,
				lineColors: ['#242d3c', '#55FFA8'] // Colores de las líneas
			});
