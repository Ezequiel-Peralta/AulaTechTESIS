<?php
$subject_info = $this->crud_model->get_subject_info2($subject_id);
    ...
    <div class="profile-details card mt-4" style="background-color: #fff; border-radius: 15px; padding: 10px 20px 20px 20px;">
        <div class="card-body">
            ...
            <div class="profile-container"> 
                <?php
                    $teacher_aide_info = $this->crud_model->get_teacher_aide_info_per_section($subject['section_id']);
    ...
    <div class="profile-details card mt-4" style="background-color: #fff; border-radius: 15px; padding: 10px 20px 20px 20px;">
        <div class="card-body">
            ...
            <a href="<?php echo base_url(); ?>index.php?admin/teacher_profile/<?php echo $subject['teacher_id'];?>">
                <div class="profile-container">
                    <?php
                        $teacher_info = $this->crud_model->get_teacher_info_per_subject2($subject['subject_id']);
                        ?>
                        <div class="profile-card"> 
    ...
    <div class="profile-details card mt-4" style="background-color: #fff; border-radius: 15px; padding: 10px 20px 20px 20px;">
        <div class="card-body">
            ...
            <br>
                <div class="profile-container"> 
                    <?php
                        $student_info = $this->crud_model->get_student_info_per_section2($subject['section_id']);
