					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="tab2-6">
							<div class="row">
								<div class="col-md-12">
                                    <div class="form-group">
                                        <label for="field-2" class="control-label"><?php echo ucfirst(get_phrase('class_and_section')); ?></label>
                                        <select name="section_id[]" class="select2" id="section_selector_holder" multiple >
                                            <option value="" selected disabled><?php echo ucfirst(get_phrase('select')); ?></option>
