...
<div class="modal-header text-center">
    ...
    <?php
            ...
            $info = $this->Teachers_model->get_teacher_info($param3);
            foreach($info as $row9):
    ?>
    ...
    <?php
            ...
            $info = $this->Guardians_model->get_guardian_info($param3);
            foreach($info as $row9):
    ?>
...
<div class="modal-body" style="height: 600px; overflow:auto; background-color: #ebebeb;">
    ...
    <div class="row">
        <div class="col-md-12 mb-4">
            <div class="card-body text-center">
                ...
                <?php
                    $teacher_info = $this->Teachers_model->get_teacher_info_per_section($row['section_id']);
    ...
    <div class="profile-details card mt-4" style="background-color: #fff; border-radius: 15px; padding: 10px 20px 20px 20px;">
        ...
        <br>
        <?php
            $guardians_info = $this->Guardians_model->get_guardian_info_per_student($row['student_id']);
