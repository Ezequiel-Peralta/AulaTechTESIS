<?php 
$edit_data		=	$this->db->get_where('teacher_aide' , array('teacher_aide_id' => $param2) )->result_array();
		...
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
            	<div class="panel-title" >
					...
					<?php echo ('Editar información del preceptor');?>
            	</div>
            </div>
			<div class="panel-body">
                    <?php echo form_open(base_url() . 'index.php?admin/teachersAide/do_update/'.$row['teacher_aide_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                                ...
                                <div class="col-sm-5">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        ...
                                        <img src="<?php echo $this->crud_model->get_image_url('teacher_aide',$row['name'],$row['dni']);?>"  alt="...">
                                        </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Dni');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="dni" value="<?php echo $row['dni'];?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Fecha de nacimiento');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="datepicker form-control" name="birthday" value="<?php echo $row['birthday'];?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Genero');?></label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Celular');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="phone_cel" value="<?php echo $row['phone_cel'];?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Teléfono fijo');?></label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Contraseña');?></label>
                                <div class="col-sm-5">
