...
<?php echo form_open(base_url() . 'index.php?admin/sections/create/' , array('class' => 'form-horizontal form-groups-bordered validate'));?>
            ...
            <div class="panel" data-collapsed="0">
                <div class="panel-body">
                    <div class="form-group">
                        <div class="group">
                            <input required="" type="text" class="input" name="name" data-validate="required" data-message-required="<?php echo ucfirst(get_phrase('required_value')); ?>">
                            <span class="bar"></span>
                    ...
                    <div class="form-group">
                        <div class="group">
                            <input required="" type="text" class="input" name="letter_name" data-validate="required" data-message-required="<?php echo ucfirst(get_phrase('required_value')); ?>">
                            <span class="bar"></span>
                    ...
                    <div class="form-group">
                        <div class="group">
                            ...
                            <select name="shift_id" id="shift_id" class="form-control select" data-validate="required" data-message-required="<?php echo ucfirst(get_phrase('required_value')); ?>">
                                ...
                                <option value="1"><?php echo ucfirst(get_phrase('morning'));?></option>
                                <option value="2"><?php echo ucfirst(get_phrase('afternoon'));?></option>
                            </select>
                            <span class="bar"></span>
                        </div>
                    </div>
