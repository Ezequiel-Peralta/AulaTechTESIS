...
<div class="modal-header text-center">
    ...
    <h4 class="modal-title"><i class="entypo-pencil"></i><?php echo 'Editar curso'?></h4>
</div>

<?php echo form_open(base_url() . 'index.php?admin/classes/update/'.$row['class_id'] , array('class' => 'form-horizontal form-groups-bordered validate'));?>
