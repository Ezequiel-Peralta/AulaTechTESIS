...
<?php
$subject_info = $this->Subject_model->get_student_info_per_section2($param2);
        ...
        <div class="card-body">
            ...
            <ul class="info-list">
                ...
                <li>
                    ...
                    <span class="info-cell">
                        <?php
                            $teacher_info = $this->Teacher_model->get_teacher_info_per_subject($row['subject_id']);
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="card-body text-center">
                                    ...
                                    <div class="student-avatars">
                                        <?php 
                                        $student_info = $this->Student_model->get_student_info_per_section($row['section_id']);
