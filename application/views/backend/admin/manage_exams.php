                ...
                <table class="table table-bordered datatable table-hover table-striped" id="all_class_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo base_url(); ?>index.php?admin/exams_information/<?php echo $section['section_id']; ?>" class="btn btn-table btn-white btn-info-hover" title="<?php echo ucfirst(get_phrase('view')); ?>">
