...
$edit_data = $this->crud_model->get_principal_info($principal_id);
	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			<div class="panel-body">
                <?php echo form_open(base_url() . 'index.php?admin/principal/update/'.$principal_id , array('class' => 'form-wizard validate', 'enctype' => 'multipart/form-data'));?>
