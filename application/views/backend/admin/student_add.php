			...
			<div class="panel-body">
                <?php echo form_open(base_url() . 'index.php?admin/student/create/' , array('class' => 'form-wizard validate', 'enctype' => 'multipart/form-data'));?>
					...
					<ul>
						...
						<li>
							<a href="#tab2-8" data-toggle="tab"><span>8</span><?php echo ucfirst(get_phrase('confirmation')); ?></a>
						</li>
					</ul>
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										...
										<input class="form-control" name="enrollment" id="enrollment" data-validate="required" data-message-required="<?php echo ucfirst(get_phrase('required_value')); ?>" data-mask="9999" placeholder=""/>
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<span id="birthday-error" style="color:red; display:none;">La edad debe estar entre 12 y 18 años.</span>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<textarea class="form-control" style="resize: vertical;" name="about" id="about" rows="5" ></textarea>
									</div>
								</div>
							</div>
						</div>
										...
										<div class="fileinput fileinput-new" data-provides="fileinput">
											...
											<div>
												<span class="btn btn-info btn-file">
													<span class="fileinput-new"><?php echo ucfirst(get_phrase('select')); ?></span>
													<span class="fileinput-exists"><?php echo ucfirst(get_phrase('change')); ?></span>
													<input type="file" name="medical_record_file" accept="image/*,application/pdf">
												</span>
												<a href="#" class="btn btn-orange fileinput-exists" data-dismiss="fileinput"><?php echo ucfirst(get_phrase('remove')); ?></a>
											</div>
										</div>
										...
										<div id="guardian_container">
											<div class="guardian-entry">
												<select name="guardian_id[]" class="form-control" >
													...
													?>
													<option value="<?php echo $row['guardian_id'];?>">
												...
												<button type="button" title="<?php echo ucfirst(get_phrase('remove')); ?>" class="btn btn-success" onclick="addGuardianEntry()">+</button>
											</div>
										</div>
									</div>              
								</div>
