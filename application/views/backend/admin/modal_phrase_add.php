<div class="modal-header text-center">
    ...
    <h4 class="modal-title"><i class="entypo-plus"></i><?php echo 'Añadir frase'?></h4>
</div>

<?php echo form_open(base_url() . 'index.php?admin/language_settings/add_phrase/' , array('class' => 'form-horizontal form-groups-bordered validate'));?>
            ...
            <div class="panel" data-collapsed="0">
                <div class="panel-body">
                    <div class="form-group">
                        <div class="group">
                            <input required="" type="text" class="input" name="phrase" data-message-required="<?php echo ('Value Required');?>">
                            <span class="bar"></span>
                            <label>Frase</label>
                        </div>
                    </div>
