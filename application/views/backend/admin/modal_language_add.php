...
<?php echo form_open(base_url() . 'index.php?admin/language_settings/add_language/' , array('class' => 'form-horizontal form-groups-bordered validate'));?>
            ...
            <div class="panel" data-collapsed="0">
                <div class="panel-body">
                    <div class="form-group">
                        <div class="group">
                            <input required="" type="text" class="input" name="language" data-message-required="<?php echo ('Value Required');?>">
                            <span class="bar"></span>
                            <label>Nombre</label>
                        </div>
                    </div>
