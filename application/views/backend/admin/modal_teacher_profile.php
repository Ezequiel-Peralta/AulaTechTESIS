...
<div class="modal-header text-center">
    ...
    <?php
            ...
            $info = $this->Teachers_model->get_teacher_aide_info($param3);
            foreach($info as $row9):
    ?>
    ...
    <?php
            ...
            $info = $this->Subjects_model->get_student_info_per_section2($param3);
    ...
    <div class="profile-details card mt-4" style="background-color: #fff; border-radius: 15px; padding: 10px 20px 20px 20px;">
        <div class="card-body">
            ...
            <ul class="info-list">
                ...
                <?php
                $section_info = $this->crud_model->get_section_info_per_teacher($row['teacher_id']);
                foreach($section_info as $section): ?>
                    <div>
                        <div class="row">
                            <div class="col-md-12 mb-4">
                                <div class="card-body text-center">
                                    <h3 style="font-weight: 600; background-color: #B0DFCC; border-radius: 15px; padding: 5px 0px;"><?php echo $section['name']; ?></h3>
                                    <br>
                                    <div class="teacher-aide-avatars">
                                        <?php
                                        $teacher_aide_info = $this->Teachers_model->get_teacher_aide_info_per_section($section['section_id']);
                                        ...
                                        <div class="teacher-aide-avatar">
                                            ...
                                            <a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_teacher_aide_profile/<?php echo $teacher_aide['teacher_aide_id'];?>/<?php echo $row['teacher_id'];?>/<?php echo 'teacher';?>');">
                                    ...
                                    <div class="student-avatars">
                                        <?php 
                                        $student_info = $this->Students_model->get_student_info_per_section($section['section_id']);
                                        ...
                                        <div class="student-avatar">
                                            ...
                                            <a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_student_profile/<?php echo $student['student_id'];?>/<?php echo $row['teacher_id'];?>/<?php echo 'teacher';?>');">
...
.popover-value {
    ...
    .desk-image {
        ...
        /* filter: drop-shadow(4px 4px 4px #00BFD0) !important;  */
    }
    .student-photo {
