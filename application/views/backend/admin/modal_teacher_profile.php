                            ...
                            <div class="col-md-12 mb-4">
                                <div class="card-body text-center">
                                    ...
                                    <div class="teacher-aide-avatars">
                                        <?php
                                        $teacher_aide_info = $this->crud_model->get_teacher_aide_info_per_section($section['section_id']);
                                    ...
                                    <div class="student-avatars">
                                        <?php 
                                        $student_info = $this->crud_model->get_student_info_per_section($section['section_id']);
