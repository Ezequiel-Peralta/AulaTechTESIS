...
?>
        <tr class="text-center" id="<?php echo $student['student_id']; ?>">
            ...
            if ($used_section_history || $used_subject_history) {
                $marks = $this->crudMark->get_marks_by_student_subject2($student['student_id'], $subject['subject_id'], $academic_period_id);
            } else {
                $marks = $this->crudMark->get_marks_by_student_subject($student['student_id'], $subject['subject_id']);
            }
    ...
    <?php endforeach; ?>
                            ...
                            <?php
                                ...
                                $subjects = $this->crudSubject->get_subjects_by_section2($section_data['section_id']);
