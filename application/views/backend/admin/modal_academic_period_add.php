<div class="modal-header text-center">
    ...
    <h4 class="modal-title"><?php echo 'Añadir cicl escolar'?></h4>
</div>

<?php echo form_open(base_url() . 'index.php?admin/academic_period/create/' , array('class' => 'form-horizontal form-groups-bordered validate'));?>
            ...
            <div class="panel" data-collapsed="0">
                <div class="panel-body">
                    <div class="form-group">
                        <div class="group">
                            <input required="" type="text" class="input" name="name" id="name" data-validate="required" data-message-required="<?php echo ucfirst(get_phrase('required_value'));?>">
                            <span class="bar"></span>
                    ...
                    <div class="form-group">
                        <div class="group">
                            <input required="" type="date" class="input" name="start_date" id="start_date" data-validate="required" data-message-required="<?php echo ucfirst(get_phrase('required_value'));?>">
                            <span class="bar"></span>
                    ...
                    <div class="form-group">
                        <div class="group">
                            <input required="" type="date" class="input" name="end_date" id="end_date" data-validate="required" data-message-required="<?php echo ucfirst(get_phrase('required_value')); ?>">
                            <span class="bar"></span>
