        ...
        <div class="card-body">
            ...
            <br>
                <div class="profile-container"> 
                    <?php
                        $teacher_aide_info = $this->Teacher_model->get_teacher_aide_info_per_section($section_info['section_id']);
    ...
    <div class="profile-details card mt-4" style="background-color: #fff; border-radius: 15px; padding: 10px 20px 20px 20px;">
        <div class="card-body">
            ...
            <br>
                <div class="profile-container"> 
                    <?php
                        $student_info = $this->Student_model->get_student_info_per_section($section_info['section_id']);
