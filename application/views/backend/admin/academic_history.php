                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo base_url();?>index.php?admin/view_students_academic_history/<?php echo $row['student_id'];?>" class="btn btn-table btn-white btn-info-hover" title="<?php echo ucfirst(get_phrase('view_profile')); ?>">
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        action: function (e, dt, node, config) {
                            window.open('<?php echo base_url(); ?>index.php?admin/printStudentTableEN/<?php echo $section_id;?>', '_blank');
                        }
                    }
                ],
                colReorder: true, 
        ...
        "language": {
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        className: 'btn buttons-html5 btn-white btn-sm btn-danger-hover',
                        action: function (e, dt, node, config) {
                            window.open('<?php echo base_url(); ?>index.php?admin/printStudentTableES/<?php echo $section_id;?>', '_blank');
                        }
                    }
                ],
                colReorder: true, 
