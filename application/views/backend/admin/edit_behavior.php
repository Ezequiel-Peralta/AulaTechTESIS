<?php 
    $edit_data		=	$this->crudStudent->get_behavior_student($behavior_id);
                            ...
                            <div class="row">
									...
									<div class="form-group">
										...
										<select name="class_id" class="form-control" data-validate="required" id="class_id" 
											data-message-required="<?php echo ucfirst(get_phrase('required_value')); ?>"
												onchange="return get_class_sections(this.value)" value="<?php echo $rowBehavior['class_id'];?>">
											...
											<?php 
												...
												foreach($classes as $row3):
                                                    ...
                                                    <option value="<?php echo $row3['class_id'];?>"
                                                        <?php if($row3['class_id'] == $rowBehavior['class_id'])echo 'selected';?>>
                                                        <?php echo $row3['name'];?>°
                                                    </option>
												<?php
												endforeach;
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<select name="section_id" class="form-control" id="section_selector_holder"  data-validate="required" value="<?php echo $rowBehavior['section_id'];?>"
                                            ...
                                            <?php 
											$sections = $this->crud_model->get_section_content_by_class($rowBehavior['class_id']);
											foreach ($sections as $section):
												$selected = ($section['section_id'] == $rowBehavior['section_id']) ? 'selected' : '';
											?>
                                ...
                                <div class="col-md-4">
									<div class="form-group">
										...
										<select name="student_id" class="form-control" id="section_selector_holder_student"  data-validate="required" value="<?php echo $rowBehavior['student_id'];?>"
                                                data-message-required="<?php echo ucfirst(get_phrase('required_value')); ?>">
                                                <option value="" selected disabled>
                                                    <?php echo ucfirst(get_phrase(empty($rowBehavior['class_id']) ? 'first_select_the_class_and_section' : 'select')); ?>
                                                </option>
											<?php 
											$students = $this->crudStudent->get_student_info_per_section($rowBehavior['section_id']);
							...
							<div class="row">
                                <div class="col-md-6">
									<div class="form-group">
										...
										<select name="type" required class="form-control" id="type" data-allow-clear="true" value="<?php echo $rowBehavior['behavior_type_id'];?>" data-validate="required" data-message-required="<?php echo ucfirst(get_phrase('required_value'));?>">
											<optgroup label="<?php echo ucfirst(get_phrase( 'behavior_types'));?>">
                                                ...
                                                ?>
                                                <option value="<?php echo $row['behavior_type_id'];?>" <?php if($row['behavior_type_id'] == $rowBehavior['behavior_type_id'])echo 'selected';?>>
                                ...
                                <div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" name="date" type="date" id="date" value="<?php echo $rowBehavior['date']; ?>" data-validate="required" data-message-required="<?php echo ucfirst(get_phrase('required_value'));?>" />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label" for="comment"><?php echo ucfirst(get_phrase( 'comment'));?></label>
										<textarea class="form-control" style="resize: vertical !important;" name="comment" id="comment" rows="5" placeholder=""><?php echo $rowBehavior['comment'];?></textarea>
									</div>
								</div>
							</div>
						</div>
