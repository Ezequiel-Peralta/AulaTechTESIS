<?php
class Attendances_service extends CI_Model {
    ...
    public function get_attendance_data_for_chart($section_id) {
        try {
            $student_ids = $this->Attendances_model->get_student_ids($section_id);
            ...
            foreach ($student_ids as $student) {
                ...
                $max_date_query = $this->Attendances_model->get_max_date_for_student($student['student_id']);
    ...
    public function get_attendance_data_for_chart2($section_id) {
        try {
            ...
            foreach ($student_ids as $student) {
                ...
                $max_date_for_student = $this->Attendances_model->get_max_date_for_student($student['student_id']);
    ...
    public function get_attendance_data_for_chart_student($student_id) {
        try {
            $max_date_query = $this->Attendances_model->get_max_date_for_student($student_id);
            ...
            $attendance_data = $this->Attendances_model->get_attendance_data($student_id, $start_date, $max_date);
    ...
    private function prepare_chart_data($student_ids, $start_date, $max_date) {
        try {
            ...
            foreach ($student_ids as $student) {
                ...
                $attendance_data = $this->Attendances_model->get_attendance_data($student['student_id'], $start_date, $max_date);
    ...
    public function update_attendance($section_id, $date, $attendance_data) {
        try {
            foreach ($attendance_data as $student_id => $data) {
                $this->Attendances_model->update_attendance($student_id, $date, $section_id, $data['status'], $data['observation']);
            }
        } catch (Exception $e) {
