...
class Teacher extends CI_Controller
{
    function __construct()
    {
        ...
        $this->load->library('Teacher_service');
    ...
    function teachers_information()
    {
        ...
        $page_data['teachers'] = $this->Teacher_model->get_all_teachers();
    ...
    function teacher_profile($teacher_id = '')
    {
        ...
        $page_data['breadcrumb'] = $breadcrumb;
        $page_data['teacher'] = $this->Teacher_model->get_teacher_info($teacher_id);
    ...
    function teacher($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $insertedTeacherId = $this->Teacher_model->insert_teacher($data);
            ...
            $insertedAddressId = $this->Teacher_model->insert_address($dataAddress);
            ...
            $this->Teacher_model->insert_teacher_details($dataDetails);
        ...
        if ($param1 == 'update') {
            $teacher_id = $param2;
            $teacher_details = $this->Teacher_model->get_teacher_details($teacher_id);
            ...
            $this->Teacher_model->update_teacher($teacher_id, $data);
            ...
            $this->Teacher_model->update_address($address_id, $dataAddress);
            ...
            $this->Teacher_model->update_teacher_details($teacher_id, $dataDetails);
        ...
        if ($param1 == 'disable_teacher') {
            ...
            if ($teacher_id) {
                $this->Teacher_model->update_teacher_status($teacher_id, 0);
        ...
        if ($param1 == 'enable_teacher') {
            ...
            if ($teacher_id) {
                $this->Teacher_model->update_teacher_status($teacher_id, 1);
    ...
    function get_teachers()
    {
        ...
        foreach ($teachers as $row) {
            $teacher_details = $this->Teacher_model->get_teachers_info($row['teacher_id']);
