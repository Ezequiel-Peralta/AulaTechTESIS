...
class Attendances extends CI_Controller
{
    ...
    function manage_attendance_students($date = '', $month = '', $year = '', $section_id = '') {
        ...
        if ($_POST) {
            ...
            $this->attendances_service->update_attendance($section_id, $this->input->post('date'), $attendance_data);
    ...
    function summary_attendance_students($class_id = '', $section_id='') {
        ...
        $page_data = array(
            ...
            'day_data' => $this->attendances_service->get_attendance_data_for_chart2($section_id),
