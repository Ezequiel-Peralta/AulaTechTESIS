    ...
    function events($param1 = '', $param2 = '', $param3 = '', $param4 = '', $param5 = '', $param6 = '', $param7 = '', $param8 = '', $param9 = '', $param10 = '', $param11 = '', $param12 = '', $param13 = '', $param14 = '')
    {
        ...
        if ($param1 == 'create') {
            try {
                ...
                $result_event = $this->Events_model->create_event($event_data, $visibility_data);
                ...
                if ($result_event) {
                    ...
                    $this->session->set_flashdata('flash_message', array(
                        'title' => ucfirst(get_phrase('error_adding_event')) . '!',
                        'text' => '',
                        'icon' => 'error',
                        'showCloseButton' => 'true',
                        'confirmButtonText' => 'Aceptar',
        ...
        if ($param1 == 'update') {
            try {
                ...
                $result_event = $this->Events_model->update_event($event_id, $data, $dataEventVisibility);
                ...
                if ($result_event) {
                    ...
                    $this->session->set_flashdata('flash_message', array(
                        'title' => ucfirst(get_phrase('error_updating_event')) . '!',
                        'text' => '',
                        'icon' => 'error',
                        'showCloseButton' => 'true',
                        'confirmButtonText' => 'Aceptar',
        ...
        if ($param1 == 'disable') {
            $event_id = $param2;
            $result = $this->Events_model->update_event_status($event_id, 0);
            if ($result) {
                $this->session->set_flashdata('flash_message', array(
                ...
                $this->session->set_flashdata('flash_message', array(
                    'title' => ucfirst(get_phrase('error_disabling_event')) . '!',
                    'text' => '',
                    'icon' => 'error',
                    'showCloseButton' => 'true',
                    'confirmButtonText' => 'Aceptar',
        ...
        if ($param1 == 'enable') {
            $event_id = $param2;
            $result = $this->Events_model->update_event_status($event_id, 1);
            if ($result) {
                $this->session->set_flashdata('flash_message', array(
                ...
                $this->session->set_flashdata('flash_message', array(
                    'title' => ucfirst(get_phrase('error_enabling_event')) . '!',
                    'text' => '',
                    'icon' => 'error',
                    'showCloseButton' => 'true',
                    'confirmButtonText' => 'Aceptar',
