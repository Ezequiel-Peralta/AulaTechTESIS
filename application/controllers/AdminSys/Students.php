...
class Students extends CI_Controller
{
    ...
    function students_bulk_add($param1 = '')
    {
        ...
        function students_information($section_id = '')
        {
            ...
            $page_data['breadcrumb'] = $breadcrumb;
            $page_data['students'] = $this->Students_model->get_students_by_section($section_id);
    ...
    {
        $result = $this->Students_model->inactive_student($student_id, $status_reason);
    ...
    {
        $result = $this->Students_model->inactive_student_pre_enrollments($student_id, $status_reason);
