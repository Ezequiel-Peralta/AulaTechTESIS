...
class Behavior extends CI_Controller
{
    function __construct()
    {
        ...
        $this->load->library('Behavior_service');
    ...
    function add_behavior($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $classes = $this->behavior_model->get_classes();
        $sections = $this->behavior_model->get_sections_by_class($param2);
        $students = $this->behavior_model->get_students_by_section($param3);
        $behavior_types = $this->behavior_model->get_behavior_types();
    ...
    function edit_behavior($behavior_id = '')
    {
        ...
        $behavior_data = $this->behavior_model->get_behavior_student($behavior_id);
        $classes = $this->behavior_model->get_classes();
        $sections = $this->behavior_model->get_sections_by_class($behavior_data['class_id']);
        $students = $this->behavior_model->get_students_by_section($behavior_data['section_id']);
        $behavior_types = $this->behavior_model->get_behavior_types();
    ...
    function behavior($section_id = '')
    {
        ...
        $students = $this->Behavior_model->get_students_by_section($section_id);
    ...
    function behavior_information($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'update') {
            ...
            $this->Behavior_model->update_behavior($param2, $data);
        ...
        if ($param1 == 'disable_behavior') {
            $this->Behavior_model->update_behavior_status($param2, 0);
        ...
        if ($param1 == 'enable_behavior') {
            $this->Behavior_model->update_behavior_status($param2, 1);
    ...
    function student_behavior($student_id = '')
    {
        ...
        $student_behavior = $this->Behavior_model->get_student_behavior($student_id);
    ...
    function manage_behavior()
    {
        ...
        $active_sections = $this->Behavior_model->get_active_sections();
        $class_ids = array_column($active_sections, 'class_id');
        $all_classes_count = count($active_sections);

        $classes = $this->Behavior_model->get_classes_by_ids($class_ids);
