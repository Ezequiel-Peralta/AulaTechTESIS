...
class Enrollment extends CI_Controller
{
    ...
    function re_enrollments($section_id = '')
    {
        ...
        $students = $this->Enrollment_model->get_students_for_re_enrollment($section_id);
        $page_data['students'] = $students;

        $old_sections = $this->Enrollment_model->get_old_sections($section_id);
    ...
    function pre_enrollments()
    {
        ...
        $students = $this->Enrollment_model->get_students_for_pre_enrollment();
        $page_data['students'] = $students;
    ...
    function preenroll_student($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $section = $this->Enrollment_model->get_section_by_id($section_id);

            if ($section) {
                $class_id = $section->class_id;
                $academic_period_id = $section->academic_period_id;

                $this->Enrollment_model->update_student_details($student_id, $class_id, $section_id);

                $this->Enrollment_model->insert_academic_history($student_id, $class_id, $section_id, $academic_period_id);
        ...
        if ($param1 == 'pre_enrollment_bulk') {
            ...
            if (!empty($students)) {
                $this->Enrollment_model->bulk_update_student_details($students, $class_id, $section_id);
    ...
    function re_enrollments_student($param1 = '', $param2 = '', $param3 = '', $param4 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            if ($section) {
                ...
                $this->Enrollment_model->update_academic_history($student_id, $class_id, $section_id);
        ...
        if ($param1 == 're_enrollment_bulk') {
            ...
            if (!empty($students)) {
                ...
                $this->Enrollment_model->bulk_update_academic_history($students, $class_id, $section_id);
